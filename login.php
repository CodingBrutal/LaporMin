        ...
        <div class="card shadow-lg p-3 mb-5 bg-body-tertiary rounded border-2" style="width: 30rem;">
            <div class="card-body">
                ...
                <form>
                    ...
                    <div class="password">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="password" class="form-control fw-bold border-2 border-dark" id="password" required>
                        </div>
                    </div>
                ...
                <div class="text-center mt-3">
                    <p class="mt-2" style="font-size: 12px; font-weight: 600; color: #03254C;">Don't have an account? <a href="#" class="text-primary">Sign up</a></p>
                </div>
            </div>
        </div>
    </div>
