                ...
                <form id="laporanForm" enctype="multipart/form-data">
                    <div class="text-start">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control border-2 border-dark" id="nama" name="nama" value="<?php echo $_SESSION['nama']; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="text-start">
                        ...
                        <div class="input-group mb-3">
                            <input type="email" class="form-control border-2 border-dark" id="email" name="email" value="<?php echo $_SESSION['email']; ?>" required>
                        </div>
                    </div>
        ...
        document.getElementById('laporanForm').addEventListener('submit', function(event) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        document.getElementById('responseId').textContent = `Berhasil mengirim laporan! ID Laporan: ${response.id_lapor}`; // Ganti dengan status yang sesuai
